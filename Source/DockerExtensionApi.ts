...
import {
	DockerExtensionApi as DockerExtensionRegistryApi,
...
export class DockerExtensionApi
	implements MementoExplorerExport, DockerExtensionRegistryApi
{
	...
	public registerRegistryDataProvider<T extends RegistryItem>(
		id: string,
