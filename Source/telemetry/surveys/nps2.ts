...
export const nps2: Survey = {
	...
	buttons: new Map<string, string | undefined>([
		[
			vscode.l10n.t("Take survey"),
			"https://aka.ms/vscodedockernpsinproduct",
		],
		[vscode.l10n.t("Don't ask again"), undefined],
	]),
	prompt: vscode.l10n.t(
		"Would you be willing to take a quick feedback survey about the Docker Extension for VS Code?",
	),
...
async function isNPSEligible(): Promise<boolean> {
	return (
		vscode.env.language === "en" || vscode.env.language.startsWith("en-")
	);
}
