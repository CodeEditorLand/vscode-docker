...
export async function getArmAuth(): Promise<
	typeof import("@azure/arm-authorization")
> {
	return await import("@azure/arm-authorization");
}

export async function getArmContainerRegistry(): Promise<
	typeof import("@azure/arm-containerregistry")
> {
	return await import("@azure/arm-containerregistry");
}

export async function getStorageBlob(): Promise<
...
export async function getAzExtAzureUtils(): Promise<
	typeof import("@microsoft/vscode-azext-azureutils")
> {
...
export async function getAzExtAppService(): Promise<
	typeof import("@microsoft/vscode-azext-azureappservice")
> {
