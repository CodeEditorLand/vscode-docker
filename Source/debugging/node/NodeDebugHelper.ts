...
import {
	...
	ResolvedDebugConfigurationOptions,
	resolveDockerServerReadyAction,
} from "../DebugHelper";
import {
	DebugConfigurationBase,
	DockerDebugConfigurationBase,
} from "../DockerDebugConfigurationBase";
...
export interface NodeDebugConfiguration
	extends DebugConfigurationBase,
		NodeDebugOptions {}

export interface NodeDockerDebugConfiguration
...
export class NodeDebugHelper implements DebugHelper {
	public async provideDebugConfigurations(
		...
		const nodeOptions: NodeDockerDebugOptions =
		...
		if (nodeOptions) {
			...
			nodeOptions.localRoot = unresolveWorkspaceFolder(
	...
	public async resolveDebugConfiguration(
		...
		debugConfiguration: NodeDockerDebugConfiguration,
