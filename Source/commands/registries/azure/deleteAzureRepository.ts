...
export async function deleteAzureRepository(
	context: IActionContext,
	node?: UnifiedRegistryItem<AzureRepository>,
): Promise<void> {
	if (!node) {
	...
	const confirmDelete = l10n.t(
		'Are you sure you want to delete repository "{0}" and its associated images?',
