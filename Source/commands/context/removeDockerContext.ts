...
export async function removeDockerContext(
	...
	const removeConfirmationMessage = vscode.l10n.t(
		"Are you sure you want to remove Docker context '{0}'?",
		node.name,
	);
