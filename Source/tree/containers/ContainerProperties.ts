...
export const containerProperties: ITreePropertyInfo<ContainerProperty>[] = [
	...
	{
		property: "Compose Project Name",
		description: l10n.t(
			"Value used to associate containers launched by a 'docker-compose up' command",
		),
	},
	{
		property: "Label",
		exampleValue: "com.microsoft.created-by=visual-studio-code",
	},
];
