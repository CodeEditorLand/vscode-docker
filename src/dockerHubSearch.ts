...
const popular = [
	...
	},
	{
		...
		"is_official": true,
		"star_count": 1600,
		"description": l10n.t("The official build of CentOS."),
	},
	{
		"is_automated": false,
		"name": "node",
	...
	},
	{
		...
		"is_official": true,
		"star_count": 1600,
		"description": l10n.t("Official build of Nginx."),
	},
	{
		"is_automated": false,
		"name": "postgres",
...
export function searchImagesInRegistryHub(
	prefix: string,
	cache: boolean,
): Promise<IHubSearchResponseResult[]> {
	if (prefix.length === 0) {
