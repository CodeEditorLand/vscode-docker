...
export function isConnectRegistryTreeItem(
	item: unknown,
): item is UnifiedRegistryItem<CommonRegistryItem> {
	return (
		isCommonRegistryItem(item) && item.type === ConnectRegistryContextValue
	);
}
