...
export async function getNetCoreProjectInfo(
	target: "GetBlazorManifestLocations" | "GetProjectProperties",
	project: string,
	...
	try {
		...
		throw new Error(
			l10n.t(
				"Unable to determine project information for target '{0}' on project '{1}'",
				target,
				project,
			),
		);
